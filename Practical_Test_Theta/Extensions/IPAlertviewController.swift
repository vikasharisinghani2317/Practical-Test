...
extension UIAlertController
{
    ...
    class func showActionsheetForImagePicker(_ controller : AnyObject ,
        ...
        self.showAlert(controller, aStrMessage: aStrMessage, style: .actionSheet, aCancelBtn: "Cancel", aDistrutiveBtn: nil, otherButtonArr: ["Use Camera"], completion: completion)
    ...
    class func showActionsheetForImagePicker(_ controller : AnyObject ,
        ...
        self.showAlert(controller, position : position ,aStrMessage: aStrMessage, style: .actionSheet, aCancelBtn: "Cancel", aDistrutiveBtn: nil, otherButtonArr: ["Use Camera"], completion: completion)
    ...
    /**
     ...
     - parameter completion:  Completion block. Delete Button Index - 0 | Cancel Button Index - 1
     */
    class func showActionsheetForImagePickerWithGallery(_ controller : AnyObject ,
                                                        position : CGRect,
                                                        aStrMessage :String? ,
                                                        completion : ((Int, String) -> Void)?) -> Void {
