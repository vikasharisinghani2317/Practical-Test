...
class AJAlertController: UIViewController {
    ...
    private var strAlertTitle = Bundle.main.infoDictionary?[kCFBundleNameKey as String] as? String
    ...
    private let btnOtherColor  = UIColor.init(named: "Color_BB1C1B")
    private let btnCancelColor = UIColor.init(named: "Color_BB1C1B")
    ...
    private func setupAJAlertController(){
        ...
        lblTitle.textColor = UIColor.init(named: "Color_BB1C1B")
